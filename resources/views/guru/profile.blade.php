                    ...
                    <form action="/update-profile" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="namaGuru" name="name"
                                value="{{ $guru->name }}" placeholder="Nama Guru" required>
                        </div>
                        <div class="mb-3">
                            <label for="username" class="form-label">NIP</label>
                            <input type="number" class="form-control" id="username" name="username"
                                value="{{ $guru->username }}" placeholder="12345" required>
                        </div>
                        <div class="mb-3">
                            <label for="gender" class="form-label">Gender</label>
                            <select class="form-control" id="gender" name="gender" required>
                                <option {{ $guru->biodata && $guru->gender != null ? '' : 'selected' }} disabled hidden>-
                                    Pilih Gender -</option>
                                <option value="Pria"
                                    {{ $guru->biodata && $guru->biodata->gender == 'Pria' ? 'selected' : '' }}>Pria
                                </option>
                                <option value="Wanita"
                                    {{ $guru->biodata && $guru->biodata->gender == 'Wanita' ? 'selected' : '' }}>Wanita
                                </option>
                            </select>
                        </div>
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="tempat_lahir"
                                value="{{ $guru->biodata ? $guru->biodata->tempat_lahir : '' }}" name="tempat_lahir"
                                placeholder="Tempat Lahir" required>
                        </div>
                        <div class="mb-3">
                            <label for="tanggal_lahir" class="form-label">Tanggal Lahir</label>
                            <input type="date" class="form-control" id="tanggal_lahir"
                                value="{{ $guru->biodata ? $guru->biodata->tanggal_lahir : '' }}" name="tanggal_lahir"
                                required>
                        </div>
                        <div class="mb-3">
                            <label for="email" class="form-label">Email</label>
                            <input type="email" class="form-control" id="email"
                                value="{{ $guru->biodata ? $guru->biodata->email : '' }}" name="email"
                                placeholder="siswa@example.com">
                        </div>
                        <div class="mb-3">
                            <label for="no_hp" class="form-label">Nomor Handphone</label>
                            <input type="text" class="form-control" id="no_hp"
                                value="{{ $guru->biodata ? $guru->biodata->no_hp : '' }}" name="no_hp"
                                placeholder="+62813....">
                        </div>
