            ...
            @php
                $personalities = [
                    [
                        ...
                        'description' =>
                            'Memiliki tipe kepribadian ISTJ cenderung menjadi individu yang praktis, sistematis, dan berorientasi pada fakta. Kamu sangat terorganisir, bertanggung jawab, dan memperhatikan detail. Selain itu, ISTJ punya kemampuan yang baik dalam mengikuti prosedur dan tugas yang terstruktur.',
                    ...
                    [
                        ...
                        'description' =>
                            'Selain INFJ, ada pula kepribadian MBTI lainnya yang langka ditemui di dunia, sekitar 0,8 hingga 2% dari populasi.  Di kehidupan sosial, INTJ sering dijuluki “si kutu buku” dan terkenal sebagai pribadi yang kaku. Namun, dibalik itu semua, INTJ merupakan sosok yang ambisius, tegas, punya rasa keingintahuan yang tinggi, dan menjaga privasi.',
                    ...
                    [
                        ...
                        'description' =>
                            'Lebih senang praktik dibanding teori? Mungkin kepribadian kamu adalah ISTP! Tipe kepribadian ini mempelajari sesuatu dengan cara terjun langsung dibanding membaca. ISTP tidak takut dengan kegagalan, memiliki keinginan tinggi untuk mencoba sesuatu yang baru, spontan, dan membiarkan orang lain terlibat atau masuk dalam hidupnya.',
                    ...
                    [
                        ...
                        'description' =>
                            'INFP adalah sosok yang sangat idealis dan penuh empati. Nggak heran, mereka mempunyai kemampuan untuk memahami emosi orang lain. INFP senang menolong orang di sekitarnya, terutama yang berkaitan dengan luka batin. INFP sering mengamati keadaan di sekelilingnya sehingga memudakan mereka untuk berkomunikasi secara mendalam dengan orang lain.',
                    ...
                    [
                        ...
                        'description' =>
                            'Mereka yang memiliki tipe kepribadian ESTP biasanya senang menjadi pusat perhatian. Sangat menyenangkan, berani, menyukai tantangan, dan fleksibel. Nggak heran kalau ESTP punya teman yang banyak serta mudah beradaptasi dalam kondisi apapun. ESTP juga bertindak spontan tanpa memikirkan sesuatu terlalu lama.',
                    ...
                    [
                        ...
                        'description' =>
                            'Berbanding terbalik dengan ENFP, kepribadian ENTP menyukai perdebatan. Punya ide-ide brilian, karismatik, dan senang beradu argumen dengan orang lain. Intinya, mereka sangat tertarik berada di keramaian, terlebih jika terlibat dalam percakapan tentang sesuatu yang mereka minati. Kualitas utama dari ENTP adalah mentalnya yang kuat.',
                    ...
                    [
                        ...
                        'description' =>
                            'Kata siapa extrovert itu nggak sensitif? Tipe kepribadian ESFJ adalah orang-orang yang berhati lembut, lho. Mereka mudah tersentuh sehingga tak segan membantu orang lain yang kesusahan. ESFJ juga menyukai interaksi dengan orang banyak, ramah, populer, teliti, berorientasi pada pelayanan, serta easy going.',
                    ...
                    [
                        ...
                        'description' =>
                            'Wah, kalau ini sih tipe kepribadian aku, hihihi. ENFJ termasuk karakter yang idealis dan terkadang berusaha untuk mengubah orang lain menjadi lebih baik dari sebelumnya. Ketika ada 1 hal yang bertentangan, mereka ingin mengubahnya menjadi kesamaan, ini yang membuat ENFJ punya kemampuan komunikasi yang cukup mumpuni.',
